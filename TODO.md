...
- [x] P15-1: デバッグメニューの設定制御（案B — チェックボックス + リアルタイム再構築）(2026-02-07 完了)
...
- [x] P15-2: テキスト配置機能（案B — 水平3方向 + 垂直2方向）(2026-02-07 完了)
...
- [x] P15-3: 後回し.md §3 を Phase 13 修正済みに更新 (2026-02-07 完了)
...
| Phase 15 | デバッグメニュー設定制御 + テキスト配置 | ✅ 完了 (2026-02-07) |
